...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{ route('home') }}">
            ...
            <span>Copenhagen's Pet Shelter</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav d-flex">
                ...
                @guest
                    <li class="nav-item">
                        <!-- Task 2 Guest, step 2: add correct link in href  done -->
                        <a class="nav-link register-link" href="{{route('register')}}">Register</a>
                    </li>

                    <li class="nav-item">
                        <!-- Task 3 Guest, step 2: add correct link in href done  -->
                ...
                <!-- Task 1 Authorization, elements should appear for logged users only -->
                    <!-- Task 1 User, step 1: add name of logged user done-->
                @auth()
                    <span class="navbar-text text-black me-4 user-name">{{auth()->user()->name}} </span>
                    <li class="nav-item">
                        <!-- Task 2 User, step 3: add correct link done-->
